...
# --- Modified Demonstration on small array ---
arr = [42, 17, 89, 23, 5, 91, 64]
comparison_count = 0
...
# --- Modified Performance Analysis ---
print(
    f'\n{"Size":>8} {"DC Comps":>12} {"Naive Comps":>14} {"Formula 3n/2-2":>16}'
)
print("-" * 56)

# Changed array sizes to powers of two
for size in [16, 64, 256, 1024]:
    # Changed random number range to (1, 50000)
